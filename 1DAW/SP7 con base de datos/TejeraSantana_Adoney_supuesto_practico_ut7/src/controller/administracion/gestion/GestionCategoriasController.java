...
public class GestionCategoriasController {
    ...
    public void generarVentana(DefaultTableModel pedidosTablaModel) {  
        ...
        this.administracionCategoriasView.setTitle("Gestión de Categorías");
        
        this.hiddenLbl();
         administracionCategoriasView.setResizable(false);
        administracionCategoriasView.setLocationRelativeTo(null);
        administracionCategoriasView.setVisible(true);
    ...
    public void destruirVentana() {
        this.administracionCategoriasView.dispose();
    }
